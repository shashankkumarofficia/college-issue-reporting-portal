                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col col-xs-6">
                                <h3 class="panel-title">Faculties And Branch </h3>
                            </div> 
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-list">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-xs">Faculty Name</th>
                                    <th>Branch</th>
                                    <th>Email</th>
                                    <th>Password</th>
                                </tr> 
                            ...
                            <tbody>
                                ...
                                while ($row = mysqli_fetch_array($que)) {
                                    ...
                                    <tr>
                                        <td align='center'>
                                            <form method="POST" action="view_all_faculties.php">
...
if (isset($_POST['delete'])) {
    ...
    $select2 = "DELETE FROM faculty where Fid='$id' ";
    $result2 = mysqli_query($conn, $select2);
    echo "<script>alert('deleted')</script>";
    echo "<script>window.location.replace('view_all_faculties.php')</script>";
}
