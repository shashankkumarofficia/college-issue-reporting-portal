...
<html lang="en">
    ...
    <body>
        ...
        <?php // include './asset/index_nav.php'; ?>
        ...
        <div class="container" style="margin-top: 7%;">
            <div class="row">
                <div class="col-md-6"> 
                    <div class="card"> 
                        <form  class="box" method='post' action='admin_login_check.php'>
                            <h1>Admin Login</h1>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="email" name="A_Email" type="text" placeholder="Email" class="form-control input-md" required="">
